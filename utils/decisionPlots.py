...
import numpy as np
def decision_subplots(ax, df, classifier, df_global, title = "Training Data",steps=0.1):   
    ...
    for name, group in groups:
        ax.scatter(group.col1, group.col2, marker='o', edgecolors='black', label=name, alpha=0.4)
    ax.set_title(title)